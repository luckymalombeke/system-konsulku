...
import { BellOff, Bell, Calendar, MessageSquare, CheckCircle, XCircle, Info, UserPlus } from 'lucide-react';
import { getNotifications, markNotificationsAsRead } from '../../api';

export default function NotifikasiDosen() {
  ...
  const getIcon = (type) => {
    switch (type) {
      case 'appointment_created': return <UserPlus className="text-blue-500" />;
      case 'appointment_cancelled': return <XCircle className="text-orange-500" />;
      ...
      <div className="max-w-2xl mx-auto py-10">
        ...
        {isLoading ? (
            ...
            <div className="bg-white rounded-2xl p-12 border border-dashed border-gray-200 text-center shadow-sm">
                ...
                <p className="text-sm text-gray-500">Pemberitahuan mengenai permintaan janji temu baru dari mahasiswa akan muncul di sini.</p>
            </div>
        ) : (
